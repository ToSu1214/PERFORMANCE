...
<head>
    ...
    <style>
        body {
            background: url(${pageContext.request.contextPath}/web/base/img/222.jpg) no-repeat center center fixed;
    ...
    <div class="layui-field-box">
        <form class="layui-form layui-form-pane" lay-filter="formA">
            <div class="layui-form-item">
                <label class="layui-form-label" style="">项目编号</label>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="time1" id="time"
...
// layer.msg(code)
    function init(){
        ajax("/ProjectServlet",{code:code,action:'get'},'json',function (data){//console.log(data)
            // form.val('formA',{code:data.code,name:data.name,time1:data.time1})
            form.val('formA',data)
        })
    }
    init();

    renderLaydateTime('time');
    formOnSubmit('upd','/ProjectServlet','text', function (data) {
        console.log(data)
        if (data == 1) {
            layer.msg("修改成功",{
                time:1500,
