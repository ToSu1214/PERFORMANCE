...
<head>
    ...
    <style>
        body {
            background: url(${pageContext.request.contextPath}/web/base/img/TiTan.jpg) no-repeat center center fixed;
    ...
    <fieldset class="layui-elem-field" style="margin: 10px">
        ...
        <div class="layui-field-box">
            <form class="layui-form layui-form-pane">
                ...
                <div class="layui-form-item">
                    <div class="layui-input-inline">
                        <input type="button" value="注册" class="layui-btn layui-btn-radius layui-btn-normal" lay-submit
                               lay-filter="reg">
